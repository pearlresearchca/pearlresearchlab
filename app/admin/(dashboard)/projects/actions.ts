...
export async function updateProjectsHeroAction(formData: FormData) {
...
export async function updateProjectAction(id: string, slug: string, formData: FormData) {
  const insforge = await createInsForgeServerClient()
...
export async function updateProjectBannerAction(id: string, slug: string, url: string, imageKey: string) {
  const insforge = await createInsForgeServerClient()
  await insforge.database.from('projects').update({ banner_image_url: url, banner_image_key: imageKey }).eq('id', id)
  revalidate(slug)
}
...
export async function addProjectSectionAction(projectId: string, slug: string, formData: FormData) {
  const insforge = await createInsForgeServerClient()
...
export async function updateProjectSectionAction(id: string, slug: string, formData: FormData) {
  const insforge = await createInsForgeServerClient()
  await insforge.database
...
export async function updateProjectSectionImageAction(id: string, slug: string, url: string, imageKey: string) {
  const insforge = await createInsForgeServerClient()
  await insforge.database.from('project_sections').update({ image_url: url, image_key: imageKey }).eq('id', id)
  revalidate(slug)
}

export async function deleteProjectSectionAction(id: string, slug: string) {
  const insforge = await createInsForgeServerClient()
  await insforge.database.from('project_sections').delete().eq('id', id)
  revalidate(slug)
}
